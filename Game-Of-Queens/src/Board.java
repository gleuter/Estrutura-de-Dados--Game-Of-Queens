...
//test
  ...
  public int systemIO(String lineOrColums) {
   ...
   public LinkedList<Queens> listMovements(int line , int colums){
      LinkedList<Queens> positionedQueen = new LinkedList<Queens>();
      Queens queens = new Queens(line, colums);
      positionedQueen.add(queens);
      return   positionedQueen;
    }
...
public Board initGame(int[][] board){
  for (int i = 0; i < 2 ; i++) {
